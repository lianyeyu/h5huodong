 ...
 *
 */
public enum GzbargainExceptionEnum {
    ...
    ACT_BARGAIN_END("02008","ACT_BARGAIN_END","活动已结束"),
     ...
     * @param errChineseMsg
     */
    private GzbargainExceptionEnum(String errCode, String errMsg, String errChineseMsg) {
